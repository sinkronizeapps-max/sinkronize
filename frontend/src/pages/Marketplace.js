        ...
        <Layout>
            <section className="bg-gradient-to-br from-[#F5F0E8] to-[#FAF9F5] py-16 lg:py-20">
                <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
                    ...
                    <h1 className="font-serif-display text-4xl lg:text-5xl font-semibold tracking-tight text-[#1A1918] mt-3 mb-4">Descubra apps para divulgar.</h1>
                    <p className="text-lg text-[#524F4A] max-w-2xl">Centenas de aplicativos curados, com comissões generosas e produtos que sua audiência vai amar.</p>
                </div>
            </section>
